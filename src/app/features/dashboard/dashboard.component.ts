...
import { IncomeExpenseChartComponent } from '../../core/components/income-expense-chart/income-expense-chart.component';

@Component({
  selector: 'app-dashboard',
  standalone: true,
  imports: [CommonModule, AssetChartComponent, IncomeExpenseChartComponent],
